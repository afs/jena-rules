...
//               "sparql", ARQConstants.sparqlPrefix,
    ...
    private static <X> void entry12(Map<String, Call> mapDispatch, Map<String, Build> mapBuild, Map<Class<?>, String> mapFunctionURI,
        ...
        Build build = (u, exprs) ->{
            if ( exprs.length == 1 )
                return (Expr)maker1.create(exprs[0]);
            if ( exprs.length == 2 )
...
//        entry(mapDispatch, mapBuild, mapFunctionURI, "arq:mod", E_OpNumericMod.class, "MOD", E_OpNumericMod::new, J_SPARQLFuncOp::arq_mod);
        ...
        entry2(mapDispatch, mapBuild, mapFunctionURI, "sparql:greaterThan", E_GreaterThan.class, ">", E_GreaterThan::new, J_SPARQLFuncOp::sparql_greaterThan );
        entry2(mapDispatch, mapBuild, mapFunctionURI, "sparql:greaterThanOrEqual", E_GreaterThanOrEqual.class, ">=", E_GreaterThanOrEqual::new, J_SPARQLFuncOp::sparql_greaterThanOrEqual );
        entry2(mapDispatch, mapBuild, mapFunctionURI, "sparql:lessThan", E_LessThan.class, ">", E_LessThan::new, J_SPARQLFuncOp::sparql_lessThan);
...
//              "REPLACE", E_StrReplace::new, J_SPARQLFuncOp::sparql_replace3, E_StrReplace::new, J_SPARQLFuncOp::sparql_replace);
        ...
        // Arity N
//        entry(mapDispatch, mapBuild, mapFunctionURI,"sparql:concat", E_StrConcat.class, "CONCAT", E_StrConcat::new, J_SPARQLFuncOp::sparql_concat );
...
//        entry(mapDispatch, mapBuild, mapFunctionURI,"sparql:encode-for-uri", E_StrEncodeForURI.class, "ENCODE_FOR_URI", E_StrEncodeForURI::new, J_SPARQLFuncOp::sparql_encode_for_uri );
