...
import org.seaborne.jena.shacl_rules.lang.parser.shacl_rules_12.ParserShaclRules;
...
public class ShaclRulesParser {
    ...
    public static RuleSet parseString(String string) {
        return ParserShaclRules.parseString(string);
    }

    public static RuleSet parseFile(String filename) {
        return ParserShaclRules.parseFile(filename);
    }
    ...
    public static RuleSet parse(InputStream in, String baseURI) {
        return ParserShaclRules.parse(in, baseURI);
    }
}
